...
var SQLiteConnection = class {
  ...
  saveToLocalDisk(database) {
    return __async(this, null, function* () {
      try {
        yield this.sqlite.saveToLocalDisk({
          database
        });
        return Promise.resolve();
      } catch (err) {
  ...
  getFromLocalDiskToStore(overwrite) {
    return __async(this, null, function* () {
      ...
      try {
        yield this.sqlite.getFromLocalDiskToStore({
  ...
  echo(value) {
    return __async(this, null, function* () {
      try {
        const res = yield this.sqlite.echo({
          value
        });
  ...
  setEncryptionSecret(passphrase) {
    return __async(this, null, function* () {
      try {
        yield this.sqlite.setEncryptionSecret({
          passphrase
        });
        return Promise.resolve();
      } catch (err) {
  ...
  closeConnection(database, readonly) {
    return __async(this, null, function* () {
      try {
        if (database.endsWith(".db")) database = database.slice(0, -3);
        yield this.sqlite.closeConnection({
          database,
          readonly
        });
        const connName = readonly ? `RO_${database}` : `RW_${database}`;
  ...
  closeNCConnection(databasePath) {
    return __async(this, null, function* () {
      try {
        yield this.sqlite.closeNCConnection({
          databasePath
        });
        const connName = `RO_${databasePath})`;
        this._connectionDict.delete(connName);
  ...
  isNCDatabase(databasePath) {
    return __async(this, null, function* () {
      try {
        const res = yield this.sqlite.isNCDatabase({
          databasePath
        });
        return Promise.resolve(res);
      } catch (err) {
  ...
  checkConnectionsConsistency() {
    return __async(this, null, function* () {
      try {
        ...
        if (!res.result) this._connectionDict = /* @__PURE__ */ new Map();
        return Promise.resolve(res);
      } catch (err) {
        this._connectionDict = /* @__PURE__ */ new Map();
        return Promise.reject(err);
  ...
  importFromJson(jsonstring) {
    return __async(this, null, function* () {
      try {
        const ret = yield this.sqlite.importFromJson({
          jsonstring
        });
  ...
  isJsonValid(jsonstring) {
    return __async(this, null, function* () {
      try {
        const ret = yield this.sqlite.isJsonValid({
          jsonstring
        });
        return Promise.resolve(ret);
      } catch (err) {
  ...
  getFromHTTPRequest(url, overwrite) {
    return __async(this, null, function* () {
      const mOverwrite = overwrite != null ? overwrite : true;
      try {
        yield this.sqlite.getFromHTTPRequest({
          url,
          overwrite: mOverwrite
        });
        return Promise.resolve();
  ...
  isDatabaseEncrypted(database) {
    return __async(this, null, function* () {
      if (database.endsWith(".db")) database = database.slice(0, -3);
      try {
        const res = yield this.sqlite.isDatabaseEncrypted({
          database
        });
        return Promise.resolve(res);
      } catch (err) {
  ...
  isDatabase(database) {
    return __async(this, null, function* () {
      if (database.endsWith(".db")) database = database.slice(0, -3);
      try {
        const res = yield this.sqlite.isDatabase({
          database
        });
        return Promise.resolve(res);
      } catch (err) {
  ...
  getSyncDate() {
    return __async(this, null, function* () {
      try {
        ...
        let retDate = "";
        if (res.syncDate > 0) retDate = new Date(res.syncDate * 1e3).toISOString();
...
var CapacitorSQLite = registerPlugin("CapacitorSQLite", {
  web: () => import("./web-OVD2LF4F.js").then((m) => new m.CapacitorSQLiteWeb()),
