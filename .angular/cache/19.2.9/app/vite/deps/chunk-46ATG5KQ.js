...
import {
  ...
  RouterLink,
  UrlSerializer
} from "./chunk-KWG6OSW2.js";
import {
  DOCUMENT,
  Location,
  LocationStrategy,
  getDOM
} from "./chunk-PWK7UXPV.js";
import {
  ApplicationRef,
  Attribute,
  BehaviorSubject,
...
var isPWA = (win) => {
  var _a6;
  return !!(((_a6 = win.matchMedia) === null || _a6 === void 0 ? void 0 : _a6.call(win, "(display-mode: standalone)").matches) || win.navigator.standalone);
};
var testUserAgent = (win, expr) => expr.test(win.navigator.userAgent);
var matchMedia = (win, query) => {
  var _a6;
  return (_a6 = win.matchMedia) === null || _a6 === void 0 ? void 0 : _a6.call(win, query).matches;
};
var PLATFORMS_MAP = {
  ipad: isIpad,
  iphone: isIphone,
...
var initialize = (userConfig = {}) => {
  ...
  const isIonicElement = (elm) => {
    var _a6;
    return (_a6 = elm.tagName) === null || _a6 === void 0 ? void 0 : _a6.startsWith("ION-");
  };
...
function minLengthValidator(minLength) {
  return (control) => {
    var _a6, _b;
    const length = (_b = (_a6 = control.value) == null ? void 0 : _a6.length) != null ? _b : lengthOrSize(control.value);
...
var _FormArrayName = class _FormArrayName extends ControlContainer {
  ...
  ngOnDestroy() {
    var _a6;
    (_a6 = this.formDirective) == null ? void 0 : _a6.removeFormArray(this);
  }
  /**
   * @description
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-46ATG5KQ.js.map
