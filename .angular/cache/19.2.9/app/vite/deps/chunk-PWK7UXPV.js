...
var _PathLocationStrategy = class _PathLocationStrategy extends LocationStrategy {
  ...
  constructor(_platformLocation, href) {
    ...
    this._baseHref = (_c = (_b2 = href != null ? href : this._platformLocation.getBaseHrefFromDOM()) != null ? _b2 : (_a2 = inject(DOCUMENT).location) == null ? void 0 : _a2.origin) != null ? _c : "";
  }
  /** @nodoc */
  ngOnDestroy() {
  ...
  historyGo(relativePosition = 0) {
    var _a2, _b2;
    (_b2 = (_a2 = this._platformLocation).historyGo) == null ? void 0 : _b2.call(_a2, relativePosition);
  }
};
...
var _Location = class _Location {
  ...
  historyGo(relativePosition = 0) {
    var _a2, _b2;
    (_b2 = (_a2 = this._locationStrategy).historyGo) == null ? void 0 : _b2.call(_a2, relativePosition);
  }
  /**
...
var _NgComponentOutlet = class _NgComponentOutlet {
  ...
  get componentInstance() {
    var _a2, _b2;
    return (_b2 = (_a2 = this._componentRef) == null ? void 0 : _a2.instance) != null ? _b2 : null;
  }
...
var _DatePipe = class _DatePipe {
  ...
  transform(value, format, timezone, locale) {
    ...
    try {
      const _format = (_b2 = format != null ? format : (_a2 = this.defaultOptions) == null ? void 0 : _a2.dateFormat) != null ? _b2 : DEFAULT_DATE_FORMAT;
...
var _KeyValuePipe = class _KeyValuePipe {
  ...
  transform(input, compareFn = defaultComparator) {
    ...
    (_a2 = this.differ) != null ? _a2 : this.differ = this.differs.find(input).create();
...
function createCloudinaryUrl(path, config) {
  ...
  if ((_a2 = config.loaderParams) == null ? void 0 : _a2["rounded"]) {
    params += `,r_max`;
  }
...
var _LCPImageObserver = class _LCPImageObserver {
  ...
  initPerformanceObserver() {
    const observer = new PerformanceObserver((entryList) => {
      ...
      const imgSrc = (_b2 = (_a2 = lcpElement.element) == null ? void 0 : _a2.src) != null ? _b2 : "";
...
var _NgOptimizedImage = class _NgOptimizedImage {
  ...
  ngOnChanges(changes) {
    ...
    if (ngDevMode && ((_a2 = changes["placeholder"]) == null ? void 0 : _a2.currentValue) && true && true) {
...
var VERSION2 = new Version("19.2.8");
...
@angular/platform-browser/fesm2022/platform-browser.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-PWK7UXPV.js.map
